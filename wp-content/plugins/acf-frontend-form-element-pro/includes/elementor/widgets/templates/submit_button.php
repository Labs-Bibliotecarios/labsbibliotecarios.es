...
class Submit_Post_Widget extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->end_controls_section();
			...
			do_action( 'acff/submit_button_styles', $this );		
		}	
	...
	protected function render() {	
        ...
        $submit_button_html = '<div class="acff-submit-buttons"><input type="submit" class="acff-submit-button acf-button button button-primary" data-state="publish" value="%s" /></div>';
        	
        ?>
        <div class="acf-form-submit">
            <?php printf( $submit_button_html, $submit_value ) ?>
        </div>
        <?php
	}

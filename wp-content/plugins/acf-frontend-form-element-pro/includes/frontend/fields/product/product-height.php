...
class acf_field_product_height extends acf_field_number {
	...
	*/
    ...
    function load_value( $value, $post_id = false, $field = false ){
        $value = get_post_meta( $post_id, '_height', true );
        return $value;
    }
    

    function pre_update_value( $value, $post_id = false, $field = false ){
        update_metadata( 'post', $post_id, '_height', $value );
        return null;
    }

...
if( ! class_exists('acf_field_product_types') ) :

class acf_field_product_types extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Product Types",'acf');
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
            'label'			=> __('Default Type','acf'),
			'instructions'	=> __('Appears when creating a new product','acf'),
            'type'			=> 'select',
            'name'			=> 'default_value',
            'ui'            => 0,
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Product Types','acf'),
			'instructions'	=> __('Select the types to choose from','acf'),
			'type'			=> 'select',
...
// initialize
acf_register_field_type( 'acf_field_product_types' );

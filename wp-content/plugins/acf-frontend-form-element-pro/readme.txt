...
5. Jump into the Elementor editor and search for "ACF frontend form". Alternatively, create a form under the ACF Frontend tab.
6. Choose the desired ACF fields.
7. Configure the permisions, display, and form settings as you please.
8. Now you should an acf form on the frontend for editing a post, adding a post, editing or adding a user, and more.


== Tutorials ==  

= How to a create "New Post" form with Elementor =
https://www.youtube.com/watch?v=p3BEGMqv4yw
 ...
 * Added gutenberg Category for ACF Frontend blocks
 ...
 * Fixed "Duplicate Post" Widget missing "Select Post" option
 ...
 * Multi step forms now update $GLOBALS['acff_form'] when clicking on step tabs
